<?php
/**
* Invia dettaglio per gli esercenti delle categorie "Ristoranti" e "Pub"
*
...
**/
	...
	$sql="SELECT esercente.Insegna_Esercente,esercente.Indirizzo_Esercente,esercente.Citta_Esercente,esercente.Email_Esercente, esercente.Zona_Esercente,tipologia_esercente.Tipo_Teser,subtipologia_esercente.Subtipo_STeser,contratto_esercente.Specialita_CE, esercente.Ambiente_Esercente,esercente.Telefono_Esercente,esercente.Fasciaprezzo_Esercente,esercente.Giorno_chiusura_Esercente,esercente.Url_Esercente,contratto_esercente.Note_Varie_CE,contratto_esercente.Lunedi_mat_CE,contratto_esercente.Lunedi_sera_CE,contratto_esercente.Martedi_mat_CE,contratto_esercente.Martedi_sera_CE,contratto_esercente.Mercoledi_mat_CE,contratto_esercente.Mercoledi_sera_CE,contratto_esercente.Giovedi_mat_CE,contratto_esercente.Giovedi_sera_CE,contratto_esercente.Venerdi_mat_CE,contratto_esercente.Venerdi_sera_CE,contratto_esercente.Sabato_mat_CE,contratto_esercente.Sabato_sera_CE,contratto_esercente.Domenica_mat_CE,contratto_esercente.Domenica_sera_CE,esercente.Esercente_Virtuale,Latitudine,Longitudine						  
