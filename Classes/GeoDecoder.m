...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
   [UIApplication sharedApplication].networkActivityIndicatorVisible = NO;
    ...
    geoDataDictionary = [[[CJSONDeserializer deserializer] deserializeAsDictionary:jsonData error:&theError] retain];
...
-(void)connection:(NSURLConnection*)connection didFailWithError:(NSError*)error
{
   [UIApplication sharedApplication].networkActivityIndicatorVisible = NO;
    ...
    if(delegate && [delegate respondsToSelector:@selector(didReceiveErrorGeoDecoder:)])
        [delegate didReceiveErrorGeoDecoder:error];
}
